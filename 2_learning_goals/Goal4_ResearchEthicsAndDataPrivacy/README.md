...
**Major argument:**
- Information technology is ubiquitous, and it is developing at an unimaginable speed, affecting all aspects of our life. People are very tempted by the potential benefits brought by it. However, it also leads to an intense and potentially destabilizing encounter between big data and ethical norms, invading individual privacy, and ultimately challenging trust, democracy, and liberty. People are afraid of databases containing important and private personal information being hacked and leading to dangerous consequences.
- Ethics in scientific research is not just a list of rules, but a core part of the research itself. Scientists are not just seeking personal gain, but trying to create knowledge that can help people. The goal of research is to benefit society, not just to advance individual careers. Ethical guidelines are not obstacles, but important ways to ensure research helps people and respects their rights.
- Everyone has the right to be part of science, not just as someone who receives scientific results, but as an active participant. Technology now allows more people to join scientific research, even if they are not professional scientists. This is called 'citizen science'. These rights to participate in science and protect personal privacy are not just legal rules, but basic human rights. They exist because every person deserves respect and the opportunity to contribute to knowledge that can help society. The goal is to make science more open and inclusive, while also protecting people's personal information.
- The rights to science and privacy might seem to conflict, but they can actually work together. In health research, for example, using personal data can help scientific progress, but we also need to protect people's privacy. The key is finding a balanced approach. Instead of seeing these rights as opposing each other, we should create ways to use data responsibly. This means ensuring research benefits society, protecting individuals from potential harm, being transparent about how data is used, and giving people choices about their information. Technology offers new ways to balance these rights. By providing clear options and information, we can help people participate in science while still maintaining their privacy.

**Reflection on the project environment and future:**
- As a person that is relatively new in the data science world, it is important to keep in mind that it brings not only benefits, but also risks. We should actively reflect on this during different phase of the project.
- Science is a tool to improve human society, it would be good to also help with getting degrees, getting offered a good salary, etc. But we should always prioritize helping the society. Therefore, we should produce truthful and reliable science and use it responsibly.
- Our project directly relates to social issues and residents' well-being, which means it's crucial to involve the community in our research process. By transparently sharing our research methods and results, we can help residents understand the significance of our work, build trust, and demonstrate how scientific research can positively impact their lives. This approach transforms our project from a purely academic exercise into a collaborative effort that values community engagement and knowledge sharing.
